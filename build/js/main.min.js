...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var closeMenuButton = document.querySelector('.mobile-nav__toggle');
  var menuOpen = document.querySelector('.mobile-nav');
  var body = document.querySelector('body');
  var mobileMenu = document.querySelector('.mobile-nav');
  var mobileMenuBackdrop = document.querySelector('.mobile-nav__backdrop');
  var mobileMenuLink = document.querySelectorAll('.mobile-nav__link'); // Открывает мобильное меню
  ...
  var checkFieldsPresence = function checkFieldsPresence() {
    for (var i = 0; i < fields.length; i++) {
      if (!fields[i].value) {
        var error = generateError('Заполните поле ввода');
